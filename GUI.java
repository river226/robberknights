 ...
 * The GUI class:
 *
 * Implements the user facing portion of the program. It also fundtions as the driver for the entire game
...
public class GUI implements ActionListener {
	...
	// Redundant: Shifts the board when necessary
	...
	// Redundant: Determine if a spot is a valid spot for a new tile to be placed
